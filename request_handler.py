...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def parse_url(self, path):
        """parses the url on the slashes "/"

        Args:
            path (string): Everything that comes after the domain ex. localhost:8088/animals/1

        Returns:
            (tuple) : returns the resource (animals) and the id (1) inside a tuple
        """
    ...
    def do_PUT(self):
        """Handles the PUT requests to the server
        """
