...
def get_single_customer(id):
    """Returns the customer with the corresponding primary key (id)"""
    with sqlite3.connect("./kennel.sqlite3") as conn:
        conn.row_factory = sqlite3.Row
        db_cursor = conn.cursor()
...
def get_customers_by_email(email):
    """Returns a a list of all the customers that have the corresponding email"""
    with sqlite3.connect("./kennel.sqlite3") as conn:
        conn.row_factory = sqlite3.Row
        db_cursor = conn.cursor()
...
def delete_customer(id):
    """Deletes the customer with the corresponding primary key (id)"""
    with sqlite3.connect("./kennel.sqlite3") as conn:
        db_cursor = conn.cursor()
...
def update_customer(id, new_customer):
    """Updates the customer object that has the corresponding primary key (id)"""
    with sqlite3.connect("./kennel.sqlite3") as conn:
        db_cursor = conn.cursor()
